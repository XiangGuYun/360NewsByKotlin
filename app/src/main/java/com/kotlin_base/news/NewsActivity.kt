...
import com.kotlin_base.kotlin.utils.OnPageChange
import com.kotlin_base.kotlin.view.FragPagerUtils
import com.kotlin_base.kotlin.view.RVUtils
...
class NewsActivity : KotlinActivity() {
    ...
    @Subscribe
    fun busEvent(pair:Pair<Int,Any>){
        when(pair.first){
            1->{
                ring.show()
                ring.startAnim()
    ...
    private fun initView() {
        ring.setViewColor("#BCEE68".color())
        tlNew.setSelectedTabIndicatorColor("#BCEE68".color())
    }
